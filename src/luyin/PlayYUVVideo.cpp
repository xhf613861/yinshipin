...
#define FILENAME "E:/demo.yuv"
#define PIXEL_FORMAT SDL_PIXELFORMAT_IYUV
#define IMG_W 620
#define IMG_H 252

PlayYUVVideo::PlayYUVVideo(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PlayYUVVideo)
{
    ui->setupUi(this);
...
// 每隔一段时间就会调用
void PlayYUVVideo::timerEvent(QTimerEvent *event)
{
...
void PlayYUVVideo::on_pushButton_clicked()
{
    // 开启定时器
